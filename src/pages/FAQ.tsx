...
export default function FAQ() {
  ...
  return (
    <div>
      <SEOHead title="FAQ — Curtain Questions Answered | Curtavra Begusarai" description="Find answers about curtain types, custom orders, measurements, installation, delivery, pricing, care & returns. Curtavra — Begusarai's curtain experts." canonical="/faq" jsonLd={faqSchema} />
