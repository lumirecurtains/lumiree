...
export default function Reviews() {
  ...
  return (
    <div>
      <SEOHead
        title={`Customer Reviews${count > 0 ? ` — ${avg}★ Rating` : ''} | Curtavra Begusarai`}
        description={`Read ${count > 0 ? count : ''} genuine customer reviews of Curtavra curtains. ${count > 0 ? `Rated ${avg}/5 stars.` : ''} Premium curtain store in Begusarai, Bihar.`}
        canonical="/reviews"
        jsonLd={reviewSchema}
      />
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        ...
        {approved.length > 0 ? (
          ...
          <div className="text-center py-12">
            ...
            <p className="text-stone-500 text-sm">Be the first to share your experience with Curtavra curtains!</p>
          </div>
        )}
      </div>
    </div>
