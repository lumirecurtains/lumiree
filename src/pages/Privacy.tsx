...
export default function Privacy() {
  return (
    <div>
      <SEOHead title="Privacy Policy | Curtavra" description="Curtavra privacy policy. Learn how we collect, use, and protect your personal information when shopping for curtains." canonical="/privacy" noindex />
      ...
      <div className="max-w-4xl mx-auto px-4 py-16 prose prose-stone prose-sm max-w-none">
        ...
        <p className="text-stone-600 leading-relaxed">For any privacy-related questions, please contact us at info@curtavra.com or via our contact page.</p>
      </div>
    </div>
  );
}
