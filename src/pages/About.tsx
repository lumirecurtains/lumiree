  ...
  return (
    <div>
      ...
      <div className="relative h-[40vh] md:h-[50vh] overflow-hidden">
        <img src={STOCK_IMAGES.elegant} alt="LuxDrape showroom" className="w-full h-full object-cover" />
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <p className="text-gold-600 text-sm tracking-[0.3em] uppercase mb-2">Since 2010</p>
              <h2 className="font-heading text-3xl md:text-4xl font-bold text-stone-900 mb-6">Crafting Elegance for Every Window</h2>
              <p className="text-stone-600 leading-relaxed mb-4">
                LuxDrape was founded with a singular vision: to transform ordinary windows into extraordinary focal points. 
                We believe that the right curtains don't just dress a window — they define a room's character, mood, and personality.
              </p>
              <p className="text-stone-600 leading-relaxed mb-4">
                Our journey began in a small atelier where our founder, passionate about textiles and interior aesthetics, 
                started crafting bespoke curtains for discerning clients. Today, we serve thousands of homes, hotels, and 
                offices across the country with our premium curtain collections.
              </p>
              <p className="text-stone-600 leading-relaxed">
                Every curtain we create undergoes rigorous quality checks, from fabric selection to stitching perfection. 
                We source our materials from the finest textile mills worldwide, ensuring that each piece delivers on our 
                promise of luxury, durability, and timeless elegance.
              </p>
            </div>
            <div className="grid grid-cols-2 gap-4">
              <img src={STOCK_IMAGES.velvet} alt="Premium curtain fabric" className="rounded-xl w-full h-48 md:h-64 object-cover" loading="lazy" />
              <img src={STOCK_IMAGES.sheer} alt="Sheer curtain detail" className="rounded-xl w-full h-48 md:h-64 object-cover mt-8" loading="lazy" />
              <img src={STOCK_IMAGES.bedroom} alt="Bedroom curtain installation" className="rounded-xl w-full h-48 md:h-64 object-cover" loading="lazy" />
              <img src={STOCK_IMAGES.luxury} alt="Luxury curtain display" className="rounded-xl w-full h-48 md:h-64 object-cover mt-8" loading="lazy" />
            </div>
          </div>
        </div>
      </section>
