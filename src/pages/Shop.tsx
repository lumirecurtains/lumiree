...
export default function Shop() {
  ...
  return (
    <div className="bg-stone-50 min-h-screen">
      <SEOHead
        title={`Shop ${catName} Online in Begusarai, Bihar | Curtavra`}
        description={`Browse premium ${catName.toLowerCase()} at Curtavra. Blackout, sheer, velvet & custom options. Serving Begusarai, Patna & all Bihar. Free shipping over ₹5,000.`}
