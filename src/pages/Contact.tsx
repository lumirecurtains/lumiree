...
export default function Contact() {
  ...
  return (
    <div>
      <SEOHead title="Contact Curtavra — Curtain Shop in Begusarai, Bihar" description="Contact Curtavra for curtain inquiries, custom orders, installation bookings. Visit our Begusarai showroom or reach us via WhatsApp. Serving all Bihar." canonical="/contact" />
        ...
        <div id="map" className="mt-12 bg-white rounded-xl overflow-hidden shadow-sm border border-stone-100">
          <div className="bg-stone-200 h-64 md:h-96 flex items-center justify-center text-stone-500">
            <div className="text-center">
              ...
              <p className="font-heading font-semibold text-lg text-stone-900">Curtavra Showroom — Begusarai</p>
