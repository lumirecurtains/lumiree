...
export default function Terms() {
  return (
    <div>
      <SEOHead title="Terms & Conditions | LuxDrape" description="LuxDrape terms and conditions for curtain purchases, custom orders, shipping, returns, installation services and warranty." canonical="/terms" noindex />
