...
export default function Terms() {
  return (
    <div>
      <SEOHead title="Terms & Conditions | Curtavra" description="Curtavra terms and conditions for curtain purchases, custom orders, shipping, returns, installation services and warranty." canonical="/terms" noindex />
      ...
      <div className="max-w-4xl mx-auto px-4 py-16">
        ...
        {[
          { title: '1. General Terms', content: 'By accessing Curtavra, you agree to these terms and conditions. Our website offers premium curtains, custom window treatments, and professional installation services.' },
